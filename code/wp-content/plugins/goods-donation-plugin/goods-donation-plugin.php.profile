...
class GoodsDonationPlugin
{
	...
	public function __construct() {
		...
		add_action( 'init', array($this, 'donee_plugin_endpoint') );
		add_action( 'show_user_profile', array($this, 'donee_plugin_profile_fields') );
		add_action( 'edit_user_profile', array($this, 'donee_plugin_profile_fields') );
		add_action( 'personal_options_update', array($this, 'donee_plugin_profile_fields_save') );
		add_action( 'edit_user_profile_update', array($this, 'donee_plugin_profile_fields_save') );
	...
	*/
	function donee_plugin_profile_fields_save( $user_id ) {
